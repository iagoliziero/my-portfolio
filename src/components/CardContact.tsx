...
const CardContact = (): JSX.Element => {
    ...
    const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        emailjs.sendForm("service_k3f0d7f", 
            "template_2fck3sj", 
            form.current!, 
            "z9PH8iou7QFgNLKwz"
        ).then(() => {
        ...
        <div className="px-6 mil:px-3 w-screen md:max-w-[33rem] mil:max-w-[30rem]  ">
             <ToastContainer 
              ...
              <section className=" min-w-full items-center justify-center">
                <form ref={form} onSubmit={sendEmail} className="flex gap-5 flex-col bg-white/5 p-6 rounded-xl border-slate-300/30 border hover:bg-white/10 transition-all ease-in-out duration-300">
                  <Input type="text" name="name" placeholder="Seu nome"> Nome * </Input>
                  <Input type="email" name="email" placeholder="seuemail@gmail.com"> Email * </Input>
                  <Input type="text" name="subject" placeholder="Assunto do email">Assunto * </Input>
                    ...
                    />
                     <button type="submit" className="mt-5 flex items-center justify-center gap-2
